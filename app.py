...
# --- 🎯 ฐานข้อมูลพิกัดข้อความ (PDF CONFIG) สอบเทียบใหม่ระดับพิกเซล ---
PDF_CONFIG = {
    # บรรทัด L1: หน่วยงาน
    "faculty":        (120, 753), 
    ...
    "check_req":      (90,  714),  # กากบาท [X] ขอเบิกเงิน
    "subject":        (170, 714),  # ข้อความชื่อเรื่อง
    ...
    "check_bank":     (85,  524),  # กากบาท [X] เข้าบัญชี
    "bank_detail":    (260, 524), 
    ...
    "faculty_budget": (230, 485), 
    
    # บรรทัด L14: กากบาทในงบประมาณข้อ / ระบุหมวด
    "check_budget":   (130, 459), # กากบาท [X]
    "budget_cat":     (250, 459), 
