...
PDF_CONFIG = {
    ...
    "check_req":      (140,  645),  # ตรงช่องสี่เหลี่ยมเป๊ะ
    ...
    "amount":         (155, 553),  
    "amount_txt":     (330, 553),  # ลงในวงเล็บพอดี
    ...
    "check_bank":     (115,  513),  # ตรงช่องสี่เหลี่ยม
    "bank_detail":    (250, 513),  # ตรงเส้นประเลขบัญชี
    
    # บรรทัด L12: เพื่อใช้ในกิจกรรมดังนี้
    "project":        (210, 495),  
    
    # บรรทัด L13: โดยใช้งบประมาณของหน่วยงาน
    "faculty_budget": (190, 430),  
    
    # บรรทัด L14: กากบาทในงบประมาณข้อ / ระบุหมวด
    "check_budget":   (130, 215),  # ตรงช่องสี่เหลี่ยม
    "budget_cat":     (235, 415),  
