...
# --- 🎯 ฐานข้อมูลพิกัดข้อความ (PDF CONFIG) สอบเทียบแกน X ใหม่ทั้งหมด ---
PDF_CONFIG = {
    # บรรทัด L1: หน่วยงาน (ตำแหน่งที่ถูกต้องแล้ว)
    "faculty":        (140, 675), 
    
    # บรรทัด L2: ที่ มพย. / วันที่ / เดือน / พ.ศ. (ขยับวันที่ให้ตรงช่อง)
    "doc_no":         (100, 657), 
    "date_day":       (270, 657),  # ขยับจาก 340 -> 270
    "date_month":     (330, 657),  # ขยับจาก 400 -> 330
    "date_year":      (430, 657),  # ขยับจาก 490 -> 430
    ...
    "attach_1":       (120, 612),  # ขยับให้ชิดเส้นประซ้ายขึ้น
    
    # บรรทัด L8: ขอเบิกเงินจำนวน ... บาท ... สตางค์
    "amount":         (140, 533),  # ขยับตัวเลขชิดซ้าย
    "amount_txt":     (310, 533),  # ขยับตัวอักษรให้ลงในวงเล็บพอดี
    
    # บรรทัด L9: สั่งจ่ายให้ / โดยขอรับเงินในวันที่
    "pay_to":         (85,  513),  # ขยับชื่อผู้รับเงินเข้าที่
    "req_d":          (275, 513),  # ขยับวัน/เดือน/ปี ลงช่องพอดี
    "req_m":          (335, 513), 
    "req_y":          (420, 513), 
    
    # บรรทัด L11: กากบาทเข้าบัญชีธนาคาร / เลขที่
    "check_bank":     (94,  497),  
    "bank_detail":    (210, 497),  # ขยับเลขบัญชีให้ตรงจุดไข่ปลา
    
    # บรรทัด L12: เพื่อใช้ในกิจกรรมดังนี้
    "project":        (180, 461),  # ขยับชื่อโครงการ
    
    # บรรทัด L13: โดยใช้งบประมาณของหน่วยงาน
    "faculty_budget": (170, 431),  
    
    # บรรทัด L14: กากบาทในงบประมาณข้อ / ระบุหมวด
    "check_budget":   (134, 415),  # ขยับกากบาทลงกล่องพอดี
    "budget_cat":     (220, 415),  
    
    # ส่วนลงชื่อ (ขวาล่าง)
    "leader":         (320, 303),  # ขยับให้อยู่กึ่งกลางวงเล็บ
    "position":       (320, 276), 
}
