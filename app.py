...
PDF_CONFIG = {
    ...
    "date_month":     (365, 657),  # ตรงกับเส้นประ เดือน
    "date_year":      (445, 657),  # ตรงกับเส้นประ พ.ศ.
    
    # บรรทัด L3: เรื่อง (กากบาทขอเบิกเงิน และ เติมข้อความ)
    "check_req":      (95,  645),  # ตรงช่องสี่เหลี่ยมเป๊ะ
    "subject":        (270, 645),  # ขยับเรื่องมาอยู่หลังคำว่า "ทดรองจ่าย"
    
    # บรรทัด L5: สิ่งที่ส่งมาด้วย 1.
    "attach_1":       (135, 612),  # ตรงเส้นประ
    
    # บรรทัด L8: ขอเบิกเงินจำนวน ... บาท ... สตางค์
    "amount":         (155, 533),  
    "amount_txt":     (335, 533),  # ลงในวงเล็บพอดี
    ...
    "check_bank":     (75,  497),  # ตรงช่องสี่เหลี่ยม
    "bank_detail":    (215, 497),  # ตรงเส้นประเลขบัญชี
    ...
    "check_budget":   (115, 415),  # ตรงช่องสี่เหลี่ยม
    "budget_cat":     (235, 415),  
